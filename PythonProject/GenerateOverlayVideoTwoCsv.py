...
def main():
    csv_paths = '../SampleData/telemetry-v1-2024-01-14-16_49_48.csv'
    ...
    lap_checkpoints = laps_2_compare[0]
    CurveDrawTool.add_col_x_m_y_m_by_lap_checkpoints(laps_2_compare, lap_checkpoints)
    # we use first lap in laps to generate checkpoints
    df_checkpoints_lap = CurveDrawTool.get_df_checkpoints_lap(lap_checkpoints)
    CurveDrawTool.process_laps_for_x_dist([True, True], df_checkpoints_lap, laps_2_compare)
